                        ...
                        <div class="header__wrapper">
                            ...
                            <div class="header__language">
                                ...
                                <div class="header__language-content">
                                    <a href="${pageContext.servletContext.contextPath}/controller?command=changeLanguage&language=en" class="header__language-link">EN</a>
                                    <a href="${pageContext.servletContext.contextPath}/controller?command=changeLanguage&language=ru" class="header__language-link">RU</a>
                                    <a href="${pageContext.servletContext.contextPath}/controller?command=changeLanguage&language=by" class="header__language-link">BY</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="login-form" action="${pageContext.request.contextPath}/controller?command=login" method="post">
                        <fieldset class="login-form__wrap">
                            <p class="login-form__info">
                                ...
                                <input type="password" name="password" class="login-form__field" placeholder="Password">
